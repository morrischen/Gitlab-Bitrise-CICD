...
* ![App Store Connect](./image/fig.11-1.png)

* 點擊"+"按鈕產生API金鑰
* 名稱輸入`Bitrise-Developer`，並下載金鑰，`金鑰只能下載一次必須保存好`
* 存取權限給予`開發者`
* ![產生API金鑰](./image/fig.11-2.png)
...
* ![Code Signing](./image/fig.14-11.png)
